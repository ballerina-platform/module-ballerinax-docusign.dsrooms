...
public isolated client class Client {
    ...
    public isolated function init(ApiKeysConfig apiKeyConfig, ConnectionConfig config =  {}, string serviceUrl = "https://demo.rooms.docusign.com/restapi") returns error? {
